...
* **Power Limit:** Был изменён на 800 (`80 ВАТТ`) по умолчанию.
---
...
* `Acer Aspire 5742G-unlock.bin` — Модифицированный дамп с разблокированными меню `Advanced` (вместо `Security`) и `Power` (вместо `Information`), а также всеми встроенными оптимизациями (PRO-мод).
